...
public class TestOtherMethods {
	...
	@Before
	public void setUp() {
		r11 = new CenterBasedRhombus();
		r12 = new CenterBasedRhombus(new Point(0, 0), Math.PI / 2, 1);
		r13 = new CenterBasedRhombus(new Point(1, 1), Math.PI / 3, 6);

		r21 = new PointsBasedRhombus();
		r22 = new PointsBasedRhombus(new Point(0, 0), Math.PI / 2, 1);
		r23 = new PointsBasedRhombus(new Point(1, 1), Math.PI / 3, 6);
	}
	...
	public void testGetCopy() {
		...
		r12 = new CenterBasedRhombus(c, Math.PI / 2, 4);
		c.setX(20);
		...
		r22 = new CenterBasedRhombus(c, Math.PI / 2, 4);
		c.setX(20);
